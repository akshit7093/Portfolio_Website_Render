...
const CHATBOT = [
    {
        ...
        rows: [['Akshit Sharma', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Akshit Sharma', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Akshit Sharma', 'Mixing, Composition, & Foley'],
...
const Chatbot: React.FC<ChatbotProps> = (props) => {
    ...
    useInterval(() => {
        setTime(time + 1);
        // setCurrentSlide((currentSlide + 1) % CHATBOT.length);
    }, 1000);
                ...
                <div style={styles.slideContainer}>
                    {
                        <motion.div
                            ...
                            key={`section-${CHATBOT[currentSlide].title}`}
                            style={styles.section}
                        >
                            <h3 style={styles.sectionTitle}>
                                {CHATBOT[currentSlide].title}
                            </h3>
                            {CHATBOT[currentSlide].rows.map((row, i) => {
                                return (
